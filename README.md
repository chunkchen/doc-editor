...
1. [x] 表格向右拓展选区异常修复，以及拖拽行的提示修复，删除当前行和向右插入行

2. [x] 支持整个表格无边框处理，上、下、左、右、外边框、以及全 border 加粗

3. [x] 网络请求去依赖

4. [x] 超宽表格显示，始终居中 (纸张大小切换后，应该触发表格resize)
...
日期：2020-12-31
更新内容：回复支持多页... 整理接下来的任务：
- [ ]  空白页开始退格 -> 删除该页
- [ ] 超长文本，以及超长表格处理，使得使用起来，连续感（不因为分页造成内容上的断裂）难点
