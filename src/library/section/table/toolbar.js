...
export default function (section) {
  ...
  return [
    ...
    },
    {
      ...
      icon: '<span class="xa-icon icon-border-top" />',
      ...
      data: [
        ...
        {
          key: 'right',
          icon: '<span class="xa-icon icon-border-right" />',
          title: locale.border.borderRight,
          className: 'lake-button-set-list-item-icon',
        },
        {
          key: 'bottom',
          icon: '<span class="xa-icon icon-border-bottom" />',
          title: locale.border.borderBottom,
          className: 'lake-button-set-list-item-icon',
        },
        {
          key: 'left',
          icon: '<span class="xa-icon icon-border-left" />',
          title: locale.border.borderLeft,
          className: 'lake-button-set-list-item-icon',
        },
        {
          key: 'allBorder',
          icon: '<span class="xa-icon icon-border-all" />',
          title: locale.border.allBorder,
          className: 'lake-button-set-list-item-icon',
        },
        {
          key: 'outBorder',
          icon: '<span class="xa-icon icon-border-out" />',
          title: locale.border.outBorder,
          className: 'lake-button-set-list-item-icon',
        },
        {
          key: 'reset',
          icon: '<span class="xa-icon icon-border-reset" />',
