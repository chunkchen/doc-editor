...
const template = function (data, locale) {
  const icons = {
    ...
    error: '<span class="itellyou-error-icon">X</span>',
  };

  if (data.status === 'uploading') {
    return '\n      <div class="itellyou-video">\n        <div class="itellyou-video-content itellyou-video-uploading">\n          <div class="itellyou-video-center">\n            '
      .concat(icons.video, '\n            <div class="itellyou-video-name">')
      .concat(Engine.StringUtils.escape(data.name), ' (')
      .concat(
        Filesize(data.size),
        ')</div>\n            <div data-role="progress" class="itellyou-video-progress">\n              ',
      )
    ...
    return '\n      <div class="itellyou-video">\n        <div class="itellyou-video-content itellyou-video-uploaded">\n          <div class="itellyou-video-center">\n            '
      .concat(icons.video, '\n            <div class="itellyou-video-name">')
      .concat(Engine.StringUtils.escape(data.name), ' (')
      .concat(
        Filesize(data.size),
        ')</div>\n            <div class="itellyou-video-converting">\n              ',
      )
      .concat(icons.spin, '\n              <span>')
      .concat(
    ...
    return '\n      <div class="itellyou-video">\n        <div class="itellyou-video-content itellyou-video-error">\n          <div class="itellyou-video-center">\n            '
      .concat(isReject ? icons.warn : '', '\n            <div class="itellyou-video-name">')
      .concat(
        Engine.StringUtils.escape(data.name),
        '</div>\n            <div class="itellyou-video-message">',
      )
  ...
  return '\n    <div class="itellyou-video">\n      <div class="itellyou-video-content itellyou-video-done"></div>\n    </div>\n  ';
};
...
class Video extends SectionBase {
  constructor(engine, contentView) {
    ...
    this.initPlayer = (src) => {
      ...
      this.container.find('.itellyou-video-content').append(video);
  ...
  setSidebar() {
    this.engine.sidebar.set({
      ...
      className: 'itellyou-video-sidebar',
      data: this.value,
    });
  }
  ...
  activate() {
    this.container.find('.itellyou-video-content').addClass('itellyou-video-content-active');
  }

  unactivate() {
    this.container.find('.itellyou-video-content').removeClass('itellyou-video-content-active');
    if (this.engine) {
